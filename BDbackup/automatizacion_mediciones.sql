...
--
-- Host: localhost    Database: automatizacion
-- ------------------------------------------------------
...
CREATE TABLE `mediciones` (
  ...
  `id_en_servidor` varchar(8) NOT NULL,
  `nombre_servidor` varchar(45) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_en_servidor_UNIQUE` (`id_en_servidor`)
...
-- Dump completed on 2019-07-12  9:23:06
